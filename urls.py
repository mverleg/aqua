...
urlpatterns = patterns('',
    ...
    url(r'^roster/(?P<roster>[0-9]+)/copy_day/(?P<date>\d{4}-\d{2}-\d{2})/$', timeslots_copy_day, name = 'timeslots_copy_day'),
    url(r'^roster/(?P<roster>[0-9]+)/empty_day/(?P<date>\d{4}-\d{2}-\d{2})/$', timeslots_empty_day, name = 'timeslots_empty_day'),
    url(r'^roster/(?P<roster>[0-9]+)/copy_day/(?P<date>\d{4}-\d{2}-\d{2})/(?P<to>[a-z]+)/$', timeslots_copy_day, name = 'timeslots_copy_day'),
